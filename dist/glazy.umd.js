...
(function (global, factory) {
  ...
  const RING$1 = 1.0, DOUGH_TUBE$1 = 0.46, FROST_TUBE$1 = 0.54, FROST_RISE = 0.10, FROST_CLIP_Y = 0.06;
  ...
  function makeRing(THREE, opts, rng) {
    ...
    const dough = new THREE.Mesh(new THREE.TorusGeometry(RING$1, DOUGH_TUBE$1, 48, 220), makeDoughMaterial(THREE, opts, rng));
    dough.rotation.x = Math.PI / 2;
    dough.castShadow = true; dough.receiveShadow = true;
    group.add(dough);

    const frost = new THREE.Mesh(new THREE.TorusGeometry(RING$1, FROST_TUBE$1, 48, 260),
    ...
    return {
      group,
      topSurface: torusTopSampler(THREE, { ring: RING$1, tube: FROST_TUBE$1, rise: FROST_RISE }),
      frame: {},
      dispose() {},
    };
  }
